...
<body>
    ...
    <div class="c_email_body_container">
        ...
        <div class="c_email_contents_container">
            <p>Dear  <?php echo $userAccountName?>,</p>
        </div>

        <p>
            Thank you for siging up with us. Now you can enjoy as many features as possible, share content with one another, solve health problems with one another and educate each other on daily basis about preventive health control and 100% health management.
        </p>
