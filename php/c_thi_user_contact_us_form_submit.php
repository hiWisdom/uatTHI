...
<html>
    ...
    <body>
        ...
        if(isset($_POST['c_contact_form_name']) && isset($_POST['c_contact_form_tel']) && isset($_POST['c_contact_form_email']) && isset($_POST['c_contact_form_subject']) && isset($_POST['c_contact_form_message'])) {


            $name = $_POST['c_contact_form_name'];
            $telephone = $_POST['c_contact_form_tel'];
            $emailaddress = $_POST['c_contact_form_email'];
            $subject = $_POST['c_contact_form_subject'];
            ...
            // $mailFrom = "info@timobhealthinternational.org"; //mail created feom your site
            ...
            include("thi_mailing/Timob_Health_International_Contact_us_Email_Template.php");
            ...
            $sql = "INSERT INTO contact_us_db(name, telephone, emailaddress, contactsubject, contactmessage) VALUES('$name', '$telephone', '$emailaddress', '$subject', '$contactmessage')";
            
            $result = mysqli_query($connectDataBase, $sql);

            
            echo "We also sent an auto response, check your email...";
