...
<html>
    ...
    <head>
       ...
       <title>Add Article | Timob Health International | Hepatitis Corner | Outreach | Create an account</title>
       <meta charset="UTF-8">
    ...
    <body>
        ...
        <?php
            ...
            $article_categories = mysqli_query($connectDataBase, $query);
                ...
                <div class="c_content_title_header_container c_general_div">
                    ...
                    <div class="c_c_t_h_c c_content_title_container c_general_container">
                        ...
                        <div class="c_general_one">
                            ...
                            <p>
                             Add a new article to public articles.
                            </p> 
                        ...
                        <div class="c_general_two">
                            ...
                            <?php if(isset($_SESSION['c_success_message'])) : ?> 
                                ...
                                <form method="POST" action="add_article_logic.php" onsubmit="" enctype="multipart/form-data" class="c_signin_createanaccount">

                                    <div class="c_create_an_account_section c_create_an_account_section_one">
                                        <input type="text" id="c_create_an_account_accountName" class="c_create_an_account_inputs" placeholder="Enter New Article Title" title="Input blog title Here" name="article_post_title" value="<?= $title ?>"/>
                                    </div>
                                    ...
                                    <div class="c_create_an_account_section c_add_post_picture">
                                        <input type="file" id="c_blog_post_picture" class="c_create_an_account_inputs c_picture_form_file_type" name="article_post_picture"/>
                                    ...
                                    <div class="c_create_an_account_section">
                                        <textarea cols="35" rows="7" placeholder="New Article Description" id="new_Article_post_Description"  name="article_post_description" value="<? $body ?>"></textarea>
                                    </div>

                                    <br>
                                    
                                    <div class="c_create_an_account_section c_create_an_account_section_five">
                                        <input type="submit" id="c_create_an_account_accountSubmit" class="c_create_an_account_inputs" value="Add Post" name="article_post_submit"/>
                                    </div>
        ...
        <!---javascript links-->
            ...
            <script>
                  CKEDITOR.replace("new_Article_post_Description");
            </script>
